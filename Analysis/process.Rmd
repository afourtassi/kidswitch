...
d_sim_transform <-  d_sim_summary %>%
  ...
  mutate(mydist = ifelse(distance=="0.6", 1, myscale))%>% # Here I create a ligne for different which were not explicitly asked from participants because it was used as a prototype, thus dist=1
...
ggplot(d_sim_transform, 
      aes(x = labels, y = mydist, col=condition)) +
  geom_point()+
