...
var Concept_pre0 = [{category:flower, prop:0, col1:col}, {category:flower, prop:0.5, col1:col}]
...
var concept_cluster1 = [
    ...
    [{category:category[catRand[1]], prop:0, col1:col},{category:category[catRand[1]], prop:visDistDiff, col1:col}, 'different', category_name[catRand[1]]]
]

var concept_cluster2 =[
    [{category:category[catRand[2]], prop:0, col1:col},{category:category[catRand[2]], prop:visDistDiff, col1:col}, 'different', category_name[catRand[2]]],
...
var concept_catch = [
    ...
    {category:flower, prop:0.5, col1:col},
    'catch', 'flower'
]
...
var sound_train_all =  SoundLearn_cluster1.concat(catch_learn, SoundLearn_cluster2)

var sound_test_all = SoundTest_cluster1.concat(catch_test, SoundTest_cluster2)
