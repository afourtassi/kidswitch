...
\authornote{ `The experiment, sample size, exclusion criteria,
and the model's main predictions were preregistered at
\url{https://osf.io/942gv/}'

`All data and analytic code are available at
\url{https://github.com/afourtassi/kidswitch}'
...
\fbox{\parbox[b][][c]{14cm}{\centering All data and code for these analyses are available at\ \url{https://github.com/afourtassi/kidswitch}}}
\vspace{1em}
