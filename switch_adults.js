...
var concept_cluster1 = [
    [{category:category[catRand[0]], prop:0, col1:col},{category:category[catRand[0]], prop:visDist, col1:col}, 'similar', category[catRand[0]]],
    [{category:category[catRand[1]], prop:0, col1:col},{category:category[catRand[1]], prop:1, col1:col}, 'different', category[catRand[1]]]
]

var concept_cluster2 =[
    [{category:category[catRand[2]], prop:0, col1:col},{category:category[catRand[2]], prop:1, col1:col}, 'different', category[catRand[2]]],
    [{category:category[catRand[3]], prop:0, col1:col},{category:category[catRand[3]], prop:visDist, col1:col}, 'similar', category[catRand[3]]]
]
